...
URL, Endor project name, finding UUID, or optional project UUID. When the host
exposes a workspace, use the current repository and `origin` remote. If the host
